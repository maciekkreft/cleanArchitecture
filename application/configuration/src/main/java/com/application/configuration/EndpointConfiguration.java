...
import com.application.entrypoints.rest.core.init.InitController;
import com.application.entrypoints.rest.core.poll.PollController;
import com.application.entrypoints.rest.core.result.ResultController;
...
public class EndpointConfiguration {
    ...
    @Bean
    public ResultController resultController(ResultUseCase r) {
        return new ResultController(r);
    }
